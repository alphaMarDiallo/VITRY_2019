...
<body>
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-light" style="height: 10vh;">
        ...
        <div class="container with-nav">
                    ...
                    <div class="col-8">
                        <div class="card border-info">
                            <div class="card-header alert-info">
                                <h4>Je complète mes informations de réservation &nbsp; <i
                                        class="fab fa-phoenix-framework"></i></h4>
                            ...
                            <div class="card-body">
                                <form method="post" action="">
                                    <input type="hidden" id="id_voyage" name="id_voyage"
                                        value="<?php echo $id_voyage; ?>">
                                    <input type="hidden" id="prix_semaine" name="prix_semaine"
                                        value="<?php echo $fiche_voyage['prix']; ?>">
                                    <div class="row">
                                        <div class="col">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <input type="text" class="form-control"
                                                placeholder="Je pars combien de semaines ?" name="semaines"
                                                value="<?php echo $_POST['semaines'] ?? ''; ?>">
                                        </div>
                                        <div class="col">
                                            <input type="text" class="form-control" placeholder="Nombre de vacanciers"
                                                name="participants" value="<?php echo $_POST['participants'] ?? ''; ?>">
                                        </div>
                                    </div>
                                    <input type="submit" value="Confirmer ma réservation" name="confirmer"
          ...
          if ($_POST && empty($msg)) {
            ...
            <section id="confirmer">
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-info"><i class="fab fa-phoenix-framework"></i> &nbsp; Récapitulatif de
                            votre réservation pour <?php
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="alert alert-dark" role="alert">
                            <?php echo number_format($facture_total, 2, ',', ' ') ?? ''; ?> €</div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-dark text-center">Votre commande a été enregistrée le
                            <?php echo $facture_date ?? ''; ?></div>
                    </div>
                </div>

                <div class="row">
                    <div class="col-12">
                        <div class="alert alert-info" style="text-align: right;">Bon séjour &nbsp; <i
                                class="fab fa-phoenix-framework"></i>
                        </div>
                    </div>
            </section>
            <section>
        ...
        <footer class="footer">
            <div class="container">
                <span class="text-muted"><i class="fas fa-umbrella-beach"></i>&nbsp Vos vacances de rêve ... &nbsp<i
                        class="fas fa-sun"></i>&nbsp Plage ... &nbsp<i class="fas fa-city"></i>&nbsp Urbaine ... &nbsp<i
                        class="fab fa-docker"></i>&nbsp Croisière ... &nbsp<i class="fas fa-image"></i>&nbsp Montagne
                    ... &nbsp<i class="fas fa-euro-sign"></i>&nbsp A prix tout doux ... &nbsp<i
